...
from pybhatlib.models.mnp import MNPModel, MNPControl, ATEResult, mnp_ate

# Data path
data_path = os.path.join(os.path.dirname(__file__), "TRAVELMODE.csv")
...
print("\n" + "=" * 50)
print("Step 1: ATE Analysis — Base Level (AGE45 = 0)")
print("=" * 50)
...
print("\n" + "=" * 50)
print("Step 2: ATE Analysis — Treatment Level (AGE45 = 1)")
print("=" * 50)
...
print("\n" + "=" * 50)
print("Step 3: Compute Percent ATE")
print("=" * 50)
print("\nPercentage ATE:")
for i, alt in enumerate(["DA", "SR", "TR"]):
